...
<div class="career-banner text-dark-green">
	<img src="content/homepage_main_image.jpg" />
	<div class="career-caption client-caption">
		<p class="font-29 mobile-29"><b>One Less Thing</b><br><span class="text-light-green">to worry about</span></p>
...
<div class="dez-col-100 text-dark-green no-shadow">
	<div class="dez-col-40 no-shadow">
		<center><img src="content/homepage_icon_paragraph_1.jpg" class="padding-left-20" /></center>
	</div>
...
<div class="dez-col-100 text-dark-green no-shadow">
	<div class="dez-col-60 no-shadow">
		<p class="font-20 padding-7 mobile-center line-height-normal text-black">
		Meticulous is a process, exactness is a promise, but what closes the circle s our obligation to you. An obligation that transcends any transaction.<br>Which is why we can promise you, <span class="special-content no-border">one less thing to worry about.</span>
		</p>
	</div>
	<div class="dez-col-40 no-shadow">
		<center><img src="content/homepage_icon_paragraph_2.jpg" class="width-50" /></center>
	</div>
</div><!--This is the end of the second image with content only. -->

<div class="dez-col-100 no-shadow text-dark-green">
	<center><br>
		<img src="content/homepage_acutis=accuracy.jpg" class="mobile-size-100" /><br>
		<img src="content/about_green_dots.jpg" class="mobile-size-100" />
	</center>
	<p class="font-40 padding-left-10" ><b>Click, act</b><span class="text-light-green"> & go</span></p>
...
<div class="dez-col-90 padding-left-5 padding-right-5 text-dark-green no-shadow">
	<div class="dez-col-30 padding-left-3 columns no-shadow">
		<center>
			<img src="content/about_icon_paragraph_2.jpg" class="width-65" />
			<p class="font-30 mobile-center width-full"><span class="text-light-green">i-</span><span class="font-bold">Acutis</span></p>
	...
	<div class="dez-col-30 padding-left-3 columns no-shadow">
		<center>
			<img src="content/homepage_icon_make_a_payment.jpg" class="width-65" />
			<p class="font-30 mobile-center width-full"><span class="text-light-green">Make </span><span class="font-bold">a Payment</span></p>
			<img src="content/homepage_bt_pay_here.jpg" />
		</center>
	
	</div>
	<div class="dez-col-30 padding-left-3 columns no-shadow">
		<center>
			<img src="content/homepage_icon_order_supplies.jpg" class="width-65 mobile-adjust" />
			<p class="font-30 mobile-center width-full"><span class="text-light-green">Order </span><span class="font-bold">Supplies</span></p>
			<img src="content/homepage_bt_pay_order.jpg" />
		</center>
...
<div class="dez-col-100 background-soap-color no-shadow">
	<center class="padding-3">
		<p class="font-30 special-content no-border font-bold">Connect With Us</p>
		<p><img src="content/down-arrow.png" /></p>
		<p class="font-22">Sign Up to receive updates and to get involved.</p>
		...
		<p><img src="content/homepage_bt_join_un.jpg" class="contact-joinus"/></p>
	</center>
