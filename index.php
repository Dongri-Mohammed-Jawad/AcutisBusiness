...
<div class="banner-section">
	<img src="content/quick_refererence_main_image.jpg" alt="cheap drug test" />
...
<br><br>
	<h2 class="special-text no-border text-center device-center">Our New Website Is Under Development.</h2>
	<center><img src="content/landing_page_icon_time.jpg" class="project-image-vvsmall" /></center><br>
	<div class="dez-col-80 margin-left-10 no-shadow">
		<p class="text-center ">
...
<div class="dez-col-90 padding-left-5 padding-right-5 text-dark-green no-shadow">
	<div class="dez-col-30 padding-left-3 columns no-shadow">
		<center>
			...
			<h2 class=" mobile-center width-full"><span class="text-light-green">i-</span><span class="font-bold">Acutis</span></h2>
	...
	<div class="dez-col-30 padding-left-3 columns no-shadow">
		<center>
			...
			<h2 class=" mobile-center width-full"><span class="text-light-green">Make </span><span class="font-bold">a Payment</span></h2>
			<div class="dez-col-50 no-shadow">
				<center>
					<img src="content/about_arrow.jpg" /><br>
					<p class="text-center font-15">Patient</p>
			...
			<div class="dez-col-50 no-shadow">
				<center>
					...
					<p class="text-center font-15">Physician or Practice</p>
	...
	<div class="dez-col-30 padding-left-3 columns no-shadow">
		<center>
			...
			<h2 class=" mobile-center width-full"><span class="text-light-green">Order </span><span class="font-bold">Supplies</span></h2>
