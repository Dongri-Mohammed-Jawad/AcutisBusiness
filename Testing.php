...
<div class="dez-col-50 padding-left-10 no-shadow">
		<p class="mobile-text-3 device-center padding-right-5">
			Accuracy should not be taken for granted. The truth is not all labs deliver the same quality of reporting. In fact, fewer than 10% of toxicology laboratories can match our overall capabilities. These capabilities are extended to include fast turn-around time, high-quality testing and rapid response. Our commitment across these outcomes sets us apart from 90% of labs, which are unable to completely eliminate the frustration, or potential damage caused by qustionable results and inadequate client services.
		</p>
	</div>
...
<div class="dez-col-100 no-shadow">
	...
	<div class="dez-col-45 padding-5 no-shadow">
		<p class="mobile-text-3 padding-right-5">
			To ensure the highest level of service, our toxicology and clinical relations experts are available to speak with you; to provider the information you need to make individual test selections, based on medical necessity.
		</p>
	</div>
</div><!-- This is the end of the content with images main div. -->
